...
const WeatherApp = () => {
    ...
    const [city, setCity] = useState("South Africa");
    ...
    return (
        <div className="container mt-4">
            ...
            <div className="d-flex justify-content-center mb-4">
                <input
                    type="text"
                    className="form-control border border-primary w-50"
            ...
            {/* Current Weather */}
            {weatherData && (
                <div className="card mb-4 weather" >
                    <div className="card-body">
                        <h2>{weatherData.location.name}, {weatherData.location.region}, {weatherData.location.country}</h2>
                        <img className='move-right' src={weatherData.current.condition.icon} alt="weather icon" style={{ fontSize: '200px' }} />
                        ...
                        <button className="btn btn-primary" onClick={saveWeatherData}>Save Weather Data</button>
                    </div>
                </div>
            )}
            ...
            <div className="d-flex overflow-auto mb-1 fs-6 hourly">
                {hourlyForecast[0] && hourlyForecast[0].map((hour, index) => (
                    <div className="card mr-2 back-round" key={index} style={{ minWidth: '120px' }} >
